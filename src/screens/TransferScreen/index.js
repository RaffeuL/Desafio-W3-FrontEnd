...
export default function TransferScreen() {
  ...
  function transfer() {
    if(agency === '1234' && account === '12345678'){
      Alert.alert('Success', `Transfer successfully made to account ${account} with amount of R$ ${amount}`)
    }else {
  ...
  return <>
    <View style={styles.screen}>
      ...
      <Input placeholder={'Amount'} onChangeText={setAmount} keyboardType={'numeric'} error={errors.amount} onFocus={() => {handleError(null, 'amount')}}/>
